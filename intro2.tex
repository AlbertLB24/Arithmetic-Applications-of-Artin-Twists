...
%Of course, we assume familiarity with the topic, but we give appropiate references for those results that are generally less known or harder to find in the literature. 
