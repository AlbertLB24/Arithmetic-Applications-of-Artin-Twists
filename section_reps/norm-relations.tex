...
\begin{example}
    If $E / K$ has split multiplicative reduction at $\fp$ with $c_{\fp}(E / K) = n$, then $c_{\fP}(E / F^H) = e_{\fP} n$ for a place $\fP$ of $F^H$ above $\fp$. In this case the function in Example \ref{tama-ex} is $(D, I, e n)$. 
\end{example}
