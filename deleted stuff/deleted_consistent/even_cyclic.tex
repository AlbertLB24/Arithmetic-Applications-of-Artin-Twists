...
If $d$ has no odd primes factors, then $d=2^m$ for some $m\geq1$. With the results we have proven in Section {\color{red} Insert here reference when things have been reorganised}, the proof of Theorem \ref{thm_consistent_cyclic} for this case is also fairly straightforward.
