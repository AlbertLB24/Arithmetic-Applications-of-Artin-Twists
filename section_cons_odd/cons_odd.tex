...
In this section we prove the analogous result to the previous section when $F / \bQ$ is any Galois extension of odd order. As discussed in \S\ref{sec-norm-rels-test}, we expect our Norm Relations test to be "uninteresting"  because root number computations don't predict positive rank.  
